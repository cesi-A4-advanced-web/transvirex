...
/** KPI metric cards at the top of the dashboard. */
const kpis = [
    {
        label: 'À assigner',
        value: '12',
...
/** Delivery requests awaiting driver assignment. */
...
/** Currently available drivers for assignment. */
...
/** Active alerts requiring dispatcher attention. */
const alerts = [
    {
        ref: '#LIV-0086',
        message: 'Adresse introuvable — client non joignable',
        icon: XCircle,
        color: 'text-red-600',
        bg: 'bg-red-50',
    },
    {
        ref: '#LIV-0088',
        message: 'Retard estimé +45 min (trafic A6)',
        icon: AlertTriangle,
    ...
    {
        ref: '#LIV-0090',
        message: 'Colis endommagé signalé par chauffeur',
        icon: Package,
        color: 'text-orange-500',
        bg: 'bg-orange-50',
    },
