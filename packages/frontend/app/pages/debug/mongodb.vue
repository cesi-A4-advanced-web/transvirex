...
<template>
    <div class="max-w-6xl mx-auto space-y-8">
        <div class="space-y-1">
            ...
            <p class="text-gray-500">Exécuter des requêtes sur la base de données MongoDB</p>
        </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Saisissez votre requête MongoDB ci-dessous</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Textarea
                                ...
                                <div class="flex flex-wrap gap-2 mt-4">
                                    <Button @click="mongodb.execute()" :disabled="mongodb.loading">
                                        <PlayCircle v-if="!mongodb.loading" class="w-4 h-4" />
                        ...
                        <Card v-if="mongodb.results || mongodb.error">
                            <CardHeader>
                                ...
                                <CardDescription v-if="mongodb.results">
                                    ...
                                    retourné{{ mongodb.results.rowCount > 1 ? 's' : '' }}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div
                                ...
                                <div v-else-if="mongodb.results">
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead v-for="col in mongodb.results.columns" :key="col">
                                                    {{ col }}
                                                </TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            <TableRow v-for="(row, i) in mongodb.results.rows" :key="i">
                                                <TableCell v-for="col in mongodb.results.columns" :key="col">
                        ...
                        <Card v-if="!mongodb.results && !mongodb.error && !mongodb.loading">
                            <CardContent>
                    ...
                    <CardContent class="p-0">
                        <div class="grid grid-cols-1 lg:grid-cols-4">
                            <div class="lg:col-span-1 border-b lg:border-b-0 lg:border-r border-gray-200">
                                <div class="p-4">
                                    <div class="flex items-center justify-between mb-3">
                                        <h3 class="text-sm font-semibold text-gray-900">Collections</h3>
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                        ...
                                        >
                                            <RefreshCw
                                                class="w-4 h-4"
                                                :class="{
                                                    'animate-spin': mongodb.collectionsLoading,
                                                }"
                                            />
                                        </Button>
                                    </div>
                            ...
                            <div class="lg:col-span-3">
                                <div class="p-4">
                                    <div v-if="!mongodb.selectedCollection" class="text-center py-16 text-gray-400">
                                        <Database class="w-16 h-16 mx-auto text-gray-300 mb-4" />
                                    ...
                                    <div v-else-if="mongodb.collectionData">
                                        <div class="flex items-center justify-between mb-4">
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    {{ mongodb.collectionData.totalCount }}
                                                    document{{ mongodb.collectionData.totalCount > 1 ? 's' : '' }}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <ScrollArea class="max-w-full">
                                            <Table>
                                                ...
                                                <TableBody>
                                                    <TableRow v-for="(row, i) in mongodb.collectionData.rows" :key="i">
                                                        <TableCell
                                                            v-for="col in mongodb.collectionData.columns"
                                                            :key="col"
                                        ...
                                        >
                                            <div class="flex items-center gap-2 text-sm text-gray-500">
                                                <span
                                                    >Documents
                                                    {{ (mongodb.collectionPage - 1) * mongodb.collectionPageSize + 1 }}
                                                    –
                                                    {{
                                                        Math.min(
                                                            mongodb.collectionPage * mongodb.collectionPageSize,
                                                            mongodb.collectionData.totalCount,
                                                        )
                                                    }}
                                                    sur
                                                    {{ mongodb.collectionData.totalCount }}</span
                                                >
                                            </div>
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-sm text-gray-600 min-w-16 text-center">
                                                    ...
                                                    /
                                                    {{ mongodb.collectionData.totalPages }}
                                                </span>
                                                <Button
                                                    variant="outline"
                                                    size="sm"
                                                    :disabled="
                                                        mongodb.collectionPage >= mongodb.collectionData.totalPages
                                                    "
                                                    @click="mongodb.goToCollectionPage(mongodb.collectionPage + 1)"
                                                >
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <select
                                                    ...
                                                    @change="
                                                        mongodb.fetchCollectionData(mongodb.selectedCollection!, 1)
                                                    "
