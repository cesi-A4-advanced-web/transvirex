        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
                <Button v-for="tab in tabs" :key="tab.value" :variant="activeTab === tab.value ? 'default' : 'outline'" size="sm" @click="activeTab = tab.value"
                    :class="activeTab === tab.value ? 'bg-green-600 hover:bg-green-700 text-white border-green-600' : ''">
                    {{ tab.label }}
                </Button>
            </div>
                            ...
                            <TableRow v-for="d in filtered" :key="d.ref">
                                ...
                                <TableCell>
                                    <Badge :class="statusClass(d.status)">
                                        <span v-if="d.status === 'En cours'" class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-1.5 animate-pulse inline-block"></span>
                                        {{ d.status }}
                                    </Badge>
                                </TableCell>
...
const deliveries = [
    { ref: '#LIV-0088', client: 'Société Durand', destination: 'Paris 8e', parcels: 1, status: 'Livré', time: '09:15', address: '12 Rue de Rivoli', city: 'Paris 1er' },
    { ref: '#LIV-0082', client: 'SARL Martin', destination: 'Lyon Part-Dieu', parcels: 3, status: 'Livré', time: '08:00', address: '45 Av. Daumesnil', city: 'Paris 12e' },
    { ref: '#LIV-0095', client: 'Logistics Plus', destination: 'Lille Centre', parcels: 2, status: 'En cours', time: '10:30', address: '23 Rue du Temple', city: 'Paris 3e' },
    { ref: '#LIV-0100', client: 'Express Cargo', destination: 'Bordeaux Gare', parcels: 1, status: 'Planifié', time: '14:00', address: '67 Av. Parmentier', city: 'Paris 11e' },
    { ref: '#LIV-0101', client: 'Nord Fret', destination: 'Nantes Ouest', parcels: 2, status: 'Planifié', time: '15:30', address: '5 Rue Oberkampf', city: 'Paris 11e' },
    { ref: '#LIV-0079', client: 'TGV Express', destination: 'Marseille 13e', parcels: 4, status: 'Livré', time: '07:00', address: '33 Bd Voltaire', city: 'Paris 11e' },
];
