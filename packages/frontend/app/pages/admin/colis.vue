...
const parcels = [
    ...
    { ref: 'PCL-0005', invoice: 'FAC-2026-004', client: 'TGV Express', weight: '18.0', delivery: '#LIV-0094', status: 'Livré' },
    { ref: 'PCL-0006', invoice: 'FAC-2026-005', client: 'Logistics Plus', weight: '3.2', delivery: '#LIV-0095', status: 'En cours' },
    { ref: 'PCL-0007', invoice: 'FAC-2026-006', client: 'Nord Fret', weight: '42.0', delivery: '#LIV-0096', status: 'Retardé' },
];
