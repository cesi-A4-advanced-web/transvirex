                        ...
                        <div class="space-y-3">
                            <div v-for="stat in deliveryStats" :key="stat.label" class="flex items-center gap-3">
                                ...
                                <div class="flex-1 bg-muted rounded-full h-2">
                                    <div class="h-2 rounded-full transition-all" :class="stat.color" :style="{ width: stat.pct + '%' }" />
                                </div>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                <TableRow v-for="h in hubPerf" :key="h.name">
                                    ...
                                    <TableCell class="text-right font-semibold" :class="h.rate >= 95 ? 'text-green-600' : h.rate >= 85 ? 'text-orange-500' : 'text-red-500'">{{ h.rate }}%</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </CardContent>
