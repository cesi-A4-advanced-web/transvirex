...
const deliveries = [
    { ref: '#LIV-0091', client: 'Société Durand', destination: 'Paris 15e', driver: 'M. Dupont', priority: 'Standard', status: 'Livré', date: '09/06/2026' },
    { ref: '#LIV-0092', client: 'SARL Martin', destination: 'Lyon Part-Dieu', driver: 'S. Martin', priority: 'High', status: 'En cours', date: '09/06/2026' },
    { ref: '#LIV-0093', client: 'Express Cargo', destination: 'Bordeaux Centre', driver: 'A. Bernard', priority: 'Standard', status: 'En attente', date: '09/06/2026' },
    { ref: '#LIV-0094', client: 'TGV Express', destination: 'Marseille 13e', driver: 'J. Thomas', priority: 'Urgent', status: 'Livré', date: '09/06/2026' },
    { ref: '#LIV-0095', client: 'Logistics Plus', destination: 'Lille Centre', driver: 'R. Petit', priority: 'High', status: 'En cours', date: '09/06/2026' },
    { ref: '#LIV-0096', client: 'Nord Fret', destination: 'Nantes Ouest', driver: 'C. Leroy', priority: 'Standard', status: 'Retardé', date: '09/06/2026' },
    { ref: '#LIV-0097', client: 'Alsace Trans', destination: 'Strasbourg', driver: 'M. Dupont', priority: 'Low', status: 'Livré', date: '08/06/2026' },
    { ref: '#LIV-0099', client: 'Sud Logistics', destination: 'Toulouse', driver: 'A. Bernard', priority: 'Urgent', status: 'Annulé', date: '08/06/2026' },
];
